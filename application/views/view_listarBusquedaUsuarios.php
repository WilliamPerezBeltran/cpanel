...
<?php foreach($infousuario as $informacion_Usuario){?>
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><?php echo $informacion_Usuario['ciudadAlias'];?></td>
...
<script language="JavaScript1.2" type="text/javascript"> 
        ...
        { 
            ...
            { 
                var william =window.location.href="http://alianzatemporal.com.co/cpanel/index.php/Principal/desactivarUsuario/"+id;
                return true;
                console.log(william);
            } 

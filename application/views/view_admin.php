...
<?php $attributes = array('autocomplete' => 'off'); echo form_open_multipart('Principal/index',$attributes);?>
    ...
    <div class="col-md-12">
        ...
        <div class=" col-md-6">
            <div class="form-group <?php echo (form_error('Nombre')==null)?'':'has-error';?> ">
                       <label>Nombre</label>
                       <input name="Nombre" value="<?php echo set_value('Nombre');?>" type="text" class="form-control" placeholder="Nombre...">

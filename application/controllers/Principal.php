    ...
    public function index(){
        $this->load->library('form_validation');
                ...
                if($this->form_validation->run()){
                        ...
                        redirect('Principal/listarUsuarios');
        ...
        $this->load->library('form_validation');
                ...
                if($this->form_validation->run()){
                    ...
                    if(empty($info['infousuario'])){
                        redirect('Principal/failCedula');

                    }else{
                        //redirect('Principal/exitoCedula/'.$id);
                        $this->load->view('templates/header.php');
                        $this->load->view('templates/aside.php');
         ...
         public function ComentariosUsuarios($id){
            ...
            $this->load->library('form_validation');
                ...
                if($this->form_validation->run()){
                    ...
                    redirect('Principal/mostrarComentarios/'.$id);
        ...
        public function crearComentarioDesdeEditar($id){
            ...
            $info['id'] = $id;
                ...
                if($this->form_validation->run()){
                    ...
                    $this->load->model('model_principal');
                    $this->model_principal->insertarcomentario($data);
                    redirect('Principal/editarUsuario/'.$id);
               ...
               $this->load->library('form_validation');
                ...
                if($this->form_validation->run()){
                       ...
                       $this->load->model('model_principal');
                        ...
                        redirect('Principal/editarUsuario/'.$id_usuario);
